...
float tm1,tm2,vc=0,ang=0;      // velocity and time controller
float i,j,k,l,m,n;
PFont fontA;
float xmag, ymag = 0;
...
void setup() {
 ...
 // PFrame f = new PFrame();
  ...
  y=60;
  z=-60;
  tx1=70;ty1=70;tz1=0;tx2=130;ty2=70;tz2=0;
...
if(vc==2)
{
  tx1=70;ty1=70;tz1=0;tx2=70;ty2=110;tz2=0;
  vc=0;
}
}
